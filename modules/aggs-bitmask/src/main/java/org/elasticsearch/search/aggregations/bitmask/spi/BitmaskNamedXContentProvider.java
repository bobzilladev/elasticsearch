...
package org.elasticsearch.search.aggregations.bitmask.spi;
...
public class BitmaskNamedXContentProvider implements NamedXContentProvider {

    @Override
    public List<NamedXContentRegistry.Entry> getNamedXContentParsers() {
        ParseField parseField = new ParseField(BitmaskAggregationBuilder.NAME);
//        ContextParser<Object, Aggregation> contextParser = (p, name) -> ParsedMatrixStats.fromXContent(p, (String) name);
        // TODO
        ContextParser<Object, Aggregation> contextParser = null;
